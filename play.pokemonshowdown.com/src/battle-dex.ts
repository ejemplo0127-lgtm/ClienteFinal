...
export const Dex = new (class implements ModdedDex {
  ...
  resourcePrefix =
    "https://raw.githubusercontent.com/ejemplo0127-lgtm/pokemon-sprites/master/";
  /**
/*
	resourcePrefix = (() => {
		let prefix = '';
...
*/
  fxPrefix =
    "https://raw.githubusercontent.com/ejemplo0127-lgtm/pokemon-sprites/master/fx/";
  ...
  getTeambuilderSprite(
    ...
    return `background-image:url(${Dex.resourcePrefix}${
      data.spriteDir
    }${shiny}/${data.spriteid}.png);background-position:${data.x + xOffset}px ${
      data.y + yOffset
    }px;background-repeat:no-repeat;${resize}`;
  }
